					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link"
									href="<%=request.getContextPath()%>/frontend/ren_appointment/listRenAppByMEM.jsp">Appointment Management</a>
								<a class="nav-link"
									href="<%=request.getContextPath()%>/frontend/ren_lease/MEMlistOneLease.jsp">Lease Management</a>
								<a class="nav-link"
									href="<%=request.getContextPath()%>/frontend/ren_favorites/listOneRenFavorites.jsp">Favourites</a>
							</nav>
						</div>
						<!-- ------------------------------------------------------------------------------------------------- -->
						<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
						...
						<div class="collapse" id="collapsePages"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link"
									href="<%=request.getContextPath()%>/frontend/sec_ord/listSecOrds_ByShBuyerID.jsp">Order Management</a>
							</nav>
						</div>
						<!-- ------------------------------------------------------------------------------------------------- -->
						<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
						...
						<div class="collapse" id="collapsePages2"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link"
									href="<%=request.getContextPath()%>/frontend/ser_dmd/getByDmdMemID.jsp">Requests & Quotations Management</a>
								<a class="nav-link"
									href="<%=request.getContextPath()%>/frontend/ser_ord/getOrdByMemID.jsp">Order Management</a>
							</nav>
						</div>
						<!-- ------------------------------------------------------------------------------------------------- -->
					</div>
...
<%-- 											<td>${secOrdVO.shBuyerID}</td> --%>
											...
											<td>
												<FORM METHOD="post"
													...
													<input type="submit" value="查看訂單明細"> <input
														type="hidden" name="shOrdID" value="${secOrdVO.shOrdID}">
...
<!-- 													</FORM> -->
											...
											<td>
												<FORM METHOD="post"
													ACTION="<%=request.getContextPath()%>/sec_ord/SecOrdServlet.do"
													style="margin-bottom: 0px;">
													<input type="submit" value="申請退款"> <input
														type="hidden" name="secOrdID" value="${secOrdVO.shOrdID}">
