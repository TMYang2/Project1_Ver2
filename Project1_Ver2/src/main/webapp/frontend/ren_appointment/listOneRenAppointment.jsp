...
<!-- 塞頁面從這裡開始--------------------------------------------------------------------------------- -->
			...
			<h3>Appointment</h3>
			<h5><a href="frontend/ren_appointment/listRenAppByMEM.jsp">Appointment Home Page</a></h5>
...
<%-- 				<c:if test="${renAppointmentVO.aptStatus == 3}">Appointment Time Changed</c:if></td> --%>
		</tr>
		<tr>
